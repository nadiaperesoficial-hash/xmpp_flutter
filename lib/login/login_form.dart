  ...
  Widget _buildForm() {
    return ListView(
      ...
      children: [
        ...
        TextFormField(controller: _usernameController, keyboardType: _isExtended ? TextInputType.text : TextInputType.emailAddress, decoration: InputDecoration(hintText: _isExtended ? 'usuário' : 'usuário@servidor.com', prefixIcon: const Icon(Icons.person_outline), contentPadding: const EdgeInsets.fromLTRB(20, 10, 20, 10), border: OutlineInputBorder(borderRadius: BorderRadius.circular(32)))),
        const SizedBox(height: 12),
